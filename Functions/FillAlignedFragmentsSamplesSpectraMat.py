...
def FillAlignedFragmentsSamplesSpectraMat(AlignedFragmentsMat,
    ...
    AlignedFragmentsSamplesSpectraMat = AlignedFragmentsMat.copy()
    AlignedFragmentsSamplesSpectra_mz_Mat = AlignedFragments_mz_Mat.copy()
    mzVec = All_ms2[:, 0]
    mz_stdVec = All_ms2[:, 1]
    ...
    for fragment_id in np.arange(N_Fragments):
        ...
        AlignedFragmentsSamplesSpectra_mz_Mat[fragment_id, Fragments_in_line + 1] = All_ms2[mzLoc, 0]

    return [AlignedFragmentsSamplesSpectraMat, AlignedFragmentsSamplesSpectra_mz_Mat]