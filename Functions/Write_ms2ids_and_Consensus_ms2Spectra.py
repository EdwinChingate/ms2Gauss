...
def Write_ms2ids_and_Consensus_ms2Spectra(feature_id,
    ...
    #AligningFolder = WorkingDirectory + '/Alignedms2Features' + string_date
    ...
    feature_ms2s_table = FeatureTable[:, [ms2_spec_id_col, sample_id_col, explained_Int_col, summ_ms2_table_id_col, module_id_col]]
    feature_ms2sDF = pd.DataFrame(feature_ms2s_table,
                                  columns = ['ms2_id', 'Sample_id', 'explained_Int(%)', 'SummMS2Table_id', 'Slice_id']) 
